...
class Reaching:
    ...
    def __init__(self):
        ...
        self._lin_vel = 0.0
        self._ang_vel = 0.0
        self._control_base = False

        # For arm GUI
        self._joint_button = 0
        self._sel_button = 0
        self._up_arrow = False
        self._down_arrow = False
        self._joints_state = np.zeros(8)
        self._control_arm = False
    ...
    @control_base.setter
    def control_base(self,value):
        self._control_base = value


    # For arm GUI
    @property
    def joint_button(self):
        return self._joint_button

    @joint_button.setter
    def joint_button(self,value):
        self._joint_button = value

    @property
    def sel_button(self):
        return self._sel_button

    @sel_button.setter
    def sel_button(self,value):
        self._sel_button = value

    @property
    def up_arrow(self):
        return self._up_arrow

    @up_arrow.setter
    def up_arrow(self,value):
        self._up_arrow = value

    @property
    def down_arrow(self):
        return self._down_arrow

    @down_arrow.setter
    def down_arrow(self,value):
        self._down_arrow = value
    ...
    def joint_state(self,value):
        self._joints_state = value

    @property
    def control_arm(self):
        return self._control_arm

    @control_arm.setter
    def control_arm(self,value):
        self._control_arm = value
